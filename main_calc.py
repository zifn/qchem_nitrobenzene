...
def make_mol_file(file_path, CN_displacement=0, ONO_rotation=0):
    ...
    nitrogen_eq = np.array((0.0000000000, 0.0000000000, 1.4460875412))
    oxygen_eq = np.array((-1.0609615047, 0.0000000000, 2.0070363436))
    ...
    mol_input=  """BASIS
aug-cc-pCVDZ
 ground mcscf 1st order optimized nitrobenzene - with dispacement
 Generated by the Dalton Input File Plugin for Avogadro
Atomtypes=4 Angstrom Generators=2 X Y
Charge=6.0 Atoms=4
C        0.0000000000            0.0000000000           -0.0162715691
C       -1.2184150481            0.0000000000           -0.6909623749
C       -1.2097981056            0.0000000000           -2.0864880285
C        0.0000000000            0.0000000000           -2.7845537710
Charge=7.0 Atoms=1
N        0.0000000000            0.0000000000            {0}
Charge=8.0 Atoms=1
O       {1}            {2}            {3}
Charge=1.0 Atoms=3
H       -2.1413788789            0.0000000000           -0.1363404183
H       -2.1472625901            0.0000000000           -2.6234691008
H        0.0000000000            0.0000000000           -3.8652559296    
...
def parse_config(json_path):
    ...
    return output_dir, states, spin_mults, hartree_freqs_probe, hartree_freqs_drive, CN_displacements, ONO_rotations, mpi_process_numb, memory_mb, max_itter, symmetries, calculation_kind , roots
